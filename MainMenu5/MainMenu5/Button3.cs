...
namespace MainMenu5
{
    public class Button3 : Button
    {
        public Button3()
        {
            this.MouseEnter += Button3_MouseEnter;
            this.MouseLeave += Button3_MouseLeave;
            this.FlatStyle = FlatStyle.Flat;
            this.FlatAppearance.BorderSize = 1;
            this.FlatAppearance.BorderColor = Color.Black;
            this.Font = new Font("Tahoma", 14, FontStyle.Regular);
            this.Size = new Size(286, 140);
            this.BackgroundImage = Image.FromFile("E:\\نمونه فرم\\MainMenu5\\MainMenu5\\Resources\\Button3.png");
